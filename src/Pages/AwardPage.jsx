  ...
  return (
    <>
      <div className="w-full">
        <img src="/2_0KDiZ89.png" alt="IIT Roorkee Logo" className="" />
      </div>
      <div className="w-full">
        {/* Main Content */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 text-gray-800 leading-relaxed text-justify">
            <h1 className="text-xl font-bold">Award & Prizes</h1>
            <p>Distinguished Alumnus Awards</p>
            <p>IIT Roorkee Research Awards</p>
            <p>Outstanding Service Awards</p>
            <p>Ram Kumar Prize</p>
          </div>
