...
const DoraStaff = () => {
  ...
  return (
    <div className="">
      {/* Dean's Section */}
      <div className="flex flex-col md:mb- mt-10 lg:mx-40 mx-6 md:mx-16 md:mt-10">
        <div className="flex flex-col md:flex-row w-full gap-10 md:gap-20 z-10 justify-center -mt-10 sm:-mt-12 md:-mt-16 lg:-mt-20 xl:-mt-24">
