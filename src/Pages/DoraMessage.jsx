    ...
    <div className="w-full">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4 text-gray-800 leading-relaxed text-justify">
          ...
          <p>
            The mission of the DORA Office is to foster and strengthen the bond
            between alumni, students, and the institute which forms a “golden
            triangle”. Please browse through the DORA Office{" "}
            <a href="https://alumni.iitr.ac.in/home" className="text-blue-600">
              website
            </a>{" "}
            ...
            of institute-alumni connect. In addition, there are also a number of
            schemes available to promote excellence among students, faculty, and
            departments. You may choose one or more ways to connect with your
            alma mater and help it progress and built upon the strong foundation
            of 175 years.
          </p>
          <p>
            We at IIT Roorkee would be extremely delighted to have you in the
            campus. Please do make it convenient to visit your alma mater any
            time you wish to cherish the golden memories from your stay in the
            campus. The DORA office would be more than happy to help you have a
