...
const DistinguishedAlumnusAwards = () => {
    ...
    <div className="w-full">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4 text-gray-800 leading-relaxed text-justify">
          ...
          <p>
            <a
              href="/previous-awardee"
              className="text-blue-600 font-medium hover:underline"
            >
              List of Previous Distinguished Alumnus Awardees, Outstanding
              Service Awardees & Distinguished Young Alumnus Awardees
            </a>
          </p>
        </div>
...
export default DistinguishedAlumnusAwards;
