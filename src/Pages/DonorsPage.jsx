...
import { individualDonor, batchDonor } from "../Assets/donorData.js";
    ...
    <>
      ...
      <div className="w-full min-h-screen bg-white flex justify-center py-8 px-2">
        <div className="w-full max-w-6xl mx-auto">
          ...
          {/* Batch Donors Header */}
          <SectionHeader title="BATCH DONORS" />

          {/* Batch Donors from assets */}
          {batchDonor.map((donor, idx) => (
            <DonorCard
              key={donor.title + idx}
              title={donor.title}
              image={donor.image}
          ...
          <div className="w-full flex flex-col gap-6 my-8">
            <div className="w-full bg-[#2952A3] py-3 flex justify-center">
              <a
                ...
                style={{ letterSpacing: "0.03em" }}
              >
                Click here for more Batch Donations and Initiatives:
              </a>
            </div>
            <div className="w-full bg-[#2952A3] py-3 flex justify-center">
              <Link
