    ...
    <div className="w-full">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4 text-gray-800 leading-relaxed text-justify">
          <p>
            <a
              href="/GICGuidelinesupdated.pdf"
              className="text-blue-600 font-medium hover:underline"
            >
              Guidelines for Travel Support to attend Good International
          ...
          <p>
            <a
              href="/50_ADVANCE_GIC.pdf"
              className="text-blue-600 font-medium hover:underline"
            >
              50% Advance For Good International Conferences/Workshops/Symposia
            </a>
          </p>
          <p>
            <a
              href="/Claim_Form_GIC.pdf"
              className="text-blue-600 font-medium hover:underline"
            >
              Claim Form For Good International Conferences/Workshops/Symposia
            </a>
          </p>
          <p>
            <a
